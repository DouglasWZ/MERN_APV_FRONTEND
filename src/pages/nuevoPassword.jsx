...
const NuevoPassword = () => {
  ...
  /* Cuando se utiliza el useEffect es recomnedable declarar la funcion adentro del useEffect. tambien se puede hacer afuera pero va decir que requiere la dependencia */
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validar que el tamaño de la nueva contraseña sea mayor a 6 caracteres
    ...
    try {
      //Extraemos la URL y le pasamos la nueva contraseña

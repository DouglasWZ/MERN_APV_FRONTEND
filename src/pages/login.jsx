...
/* UseNavigate es el Hook que se utilizará para redireccionar al usuario */
import { Link, useNavigate } from "react-router-dom"; // para evitar las recargas de la pagina al redirigir a otro componente, se reemplaza la etiqueta <a> por Link
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if ([correo, password].includes("")) {
      ...
      return; /* Para que no siga ejecutando lo demas */
    }
    ...
    try {
      ...
      /* Almacenar el Token del usuario autenticado en el local Storage */
